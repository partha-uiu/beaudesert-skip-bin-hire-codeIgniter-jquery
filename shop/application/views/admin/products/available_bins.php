...
?>">
    <div class="span12">
        <div class="box">
            <header>
                <div class="icons"><i class="fa fa-trash" style="font-size: 20px; color: #0066cc;"></i></div>
                <h5 style="display: inline-block; font-size: 18px; font-weight: bold;"> Bins Available</h5>
            </header>
                        ...
                        <?php foreach ($items as $item) { ?>
                            <tr>
                                ...
                                <td><?php echo $item->p_title; ?></td>
                                 <td><?php echo $item->p_bin_quantity; ?></td>
                                 <td><?php $x=$item->p_bin_quantity;
                                            $y=$item->p_available_bin;
                                            $z=$x-$y;
                                            echo $z;
                                 ?></td>
                                 <td><?php echo $item->p_available_bin; ?></td>
                              <!--<td><?php // echo $item->bin_quantity; ?></td>--> 
                                ...
                                <td class="action">
                                    <a href="  <?php echo site_url(CPREFIX . "/products/bin_add/" . $item->id) ?>"><i class="icon-pencil"></i> Edit</a>&nbsp;&nbsp;
