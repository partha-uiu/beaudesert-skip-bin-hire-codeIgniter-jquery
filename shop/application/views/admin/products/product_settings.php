    ...
    <div class="span12">
        <div class="box">
            <header>
                ...
                <h5 style="display: inline-block; font-size: 18px; font-weight: bold;">Product List</h5>
            </header>
                    ...
                    <tbody>
                        <?php foreach ($items as $item) { ?>
                            <tr>
                                ...
                                <td><?php if(!empty($item->image)){ ?><img src="<?php echo site_url().$item->image; ?>" alt="" class="thumbnail" style="max-width: 60px;"><?php }else{echo 'No image available!';} ?></td>
                                <td class="action">
...
<div class="row-fluid add_show <?php if(!empty($items) && empty($index)){ echo 'hidden'; } ?>">
    <div class="span12">
        <div class="box for-form-horizontal">
            <header>
                ...
                <h5 style="display: inline-block; font-size: 18px; font-weight: bold;">Add Extra Product Settings</h5>
                <div class="toolbar">
                    <ul class="nav">
                        <li>
                            <div class="btn-group">
 ...
 <?php 
  ...
  echo $this->ahrform->input(array(
                        'name' => 'title',
                        'label' => 'Product Settings Title',
                        'type' => 'select',

                        'empty' => 'Select settings type...',
                        'options' => array('Tyre Removal' => 'Tyre Removal',
                            'Mattress Removal' => 'Mattress Removal',
                             'LPG Gas Bottle' => 'LPG Gas Bottle',
                             'TV\'s & Monitors' => 'TV\'s & Monitors',
                              'Extra Day' => 'Extra Day'
                             )
 ...
 ?>
                    <?php echo $this->ahrform->input(array('name' => 'quantity', 'type' => 'text', 'label' => 'Quantity')); ?>
                    <?php echo $this->ahrform->input(array('name' => 'price', 'type' => 'text', 'label' => 'Price')); ?>
...
//                    ?>
                    ...
                    <div class="form-actions">
                        <button value="" class="btn btn-primary" name="data[form_acion]" type="submit"><i class="fa fa-floppy-o"></i> Save</button>
                        or <a href="<?php echo site_url('/' . CPREFIX . '/products/product_settings_list') ?>"><i class="icon-backward"></i> Back to list</a>
                    </div>
                </form>
            </div>
        </div>
