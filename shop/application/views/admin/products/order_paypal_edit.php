    ...
    <div class="span12">
        <div class="box for-form-horizontal">
            <header>
                ...
                <h5 style="display: inline-block; font-size: 18px; font-weight: bold;">Edit Orders in PayPal</h5>
                <div class="toolbar">
                    <ul class="nav">
                        <li>
                            <div class="btn-group">
...
//                    ));
           ...
           <?php // echo $this->ahrform->input(array('name' => 'delivery_status', 'type' => 'text','id'=>'bin_quantity' ,'label' => 'Delivery Status       ')); ?>
