    ...
    <div class="span12">
        <div class="box for-form-horizontal">
            <header>
                ...
                <h5 style="display: inline-block; font-size: 18px; font-weight: bold;">Add Bins</h5>
                <div class="toolbar">
                    <ul class="nav">
                        <li>
                            <div class="btn-group">
...
//                    ));
                    ...
                    ?>
           <?php echo $this->ahrform->input(array('name' => 'p_title', 'type' => 'text', 'label' => 'Bin Size')); ?>
           <?php echo $this->ahrform->input(array('name' => 'p_bin_quantity', 'type' => 'text','id'=>'bin_quantity' ,'label' => 'Bin Quantity')); ?>
           <?php echo $this->ahrform->input(array('name' => 'p_available_bin', 'type' => 'text', 'id'=>'availabe_bin' ,'label' => 'Bins Available')); ?>

            <?php echo $this->ahrform->input(array('name' => 'p_summary', 'id' => 'p_summary', 'type' => 'textarea', 'label' => 'Bin Summary')); ?>

            <?php echo $this->ahrform->input(array('name' => 'p_description', 'id' => 'p_description', 'type' => 'textarea', 'label' => 'Bin Description')); ?>

           <?php echo $this->ahrform->input(array('name' => 'p_price', 'type' => 'text', 'label' => 'Bin Price')); ?>

                    <div class="control-group" id="<?php if ($this->ahrform->get('id')) {
                                echo 'edit_';
                            } ?>upload_image" >
                        <label class="control-label" for="maingraphic">Bin Image</label>
                        <div class="controls">
                            <input class="input-xlarge" name="image" type="file" id="image">
                            <div id="bannerpic" class="img-thumbnail" style="max-width:50px"></div>
                    <?php if ($this->ahrform->get('image')) {
                        ?>
                                <img class="img-thumbnail" style="max-width:50px" src="<?php echo site_url() . $this->ahrform->get('image'); ?>">
<?php } ?>
...
<?php // echo $this->ahrform->input(array('name' => 'sort_order', 'type' => 'text', 'label' => 'Sort Order', 'style'=>'max-width: 80px'));  ?>
                    <div class="form-actions">
                        ...
                        or <a href="<?php echo site_url('/' . CPREFIX . '/products/product_list') ?>"><i class="icon-backward"></i> Back to list</a>
                    </div>
                </form>
            </div>
        </div>
