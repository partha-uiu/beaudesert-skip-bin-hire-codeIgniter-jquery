    ...
    $(document).ready(function() {
        ...
        $('body').on('click','#dataTable .single-delete',function(e) {
            ...
            $.ajax({
                ...
                //xhrFields: {withCredentials: true},
                type: "POST",
                url: '<?php echo site_url(CPREFIX . "/products/deleteZone") ?>',
                dataType: 'json',
                context: $(this).parents('table'),
                data: jQuery.param({id: ids})
            }).done(function(rt) {
...
<div class="span12">
            <div class="box">
                <header>
                    ...
                    <h5 style="font-size: 18px; font-weight: bold;"> Zone/Postcode List </h5>
                </header>
                <div id="collapse4" class="body">
                    ...
                    <div class="btn-group data-list-control" style=" ">
                        ...
                        <tbody>
<?php foreach ($postcode as $ind => $item) { ?>
                                <tr>
                                  ...
                                  <td><?php echo $item->product_zone ?></td>
                                   ...
                                   <td class="action">
                                    <a href="  <?php echo site_url(CPREFIX . "/products/zone_postcode/" . $item->id) ?>"><i class="icon-pencil"></i> Edit</a>&nbsp;&nbsp;
