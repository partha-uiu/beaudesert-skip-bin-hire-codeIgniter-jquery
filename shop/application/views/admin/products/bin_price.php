    ...
    <div class="span12">
        <div class="box">
            <header>
                ...
                <h5 style="display: inline-block; font-size: 18px; font-weight: bold;">Product Waste Type</h5>
            </header>
    ...
    <div class="span12">
        <div class="box for-form-horizontal">
            <header>
                ...
                <h5 style="display: inline-block; font-size: 18px; font-weight: bold;">Add Zone/Price</h5>
                <div class="toolbar">
                    <ul class="nav">
                        <li>
                            <div class="btn-group">
...
//                        'value' => 30,
                        ...
                        'options' => empty($product) ? array() : $product
                    ));
                    ?>
...
//                    $this->ahrform->set('product_id', 28);
                    echo $this->ahrform->input(array(
                        ...
                        'type' => 'select',
//                        'value' => 30,
                        'empty' => 'Select Product Zone ...',
                        'options' => empty($product_zone) ? array() : $product_zone
                    ));
                    ?>                
...
<?php // echo $this->ahrform->input(array('name' => 'sort_order', 'type' => 'text', 'label' => 'Sort Order', 'style'=>'max-width: 80px'));   ?>
                    <div class="form-actions">
                        ...
                        or <a href="<?php echo site_url('/' . CPREFIX . '/products/bin_price_list') ?>"><i class="icon-backward"></i> Back to list</a>
                    </div>
                </form>
            </div>
        </div>
