                        ...
                        <?php foreach ($items as $item) { ?>
                            <tr>
                                <td class="center"><input class="check list-control-check" type="checkbox" value="<?php echo $item->id ?>" /></td>
                                    ...
                                    <td><?php echo $item->p_summary; ?></td>
                                    <!--<td><?php // echo $item->p_description;      ?></td>-->
                                    <td>$<?php echo $item->p_price; ?></td>
                                    <td><?php if (!empty($item->p_image_url)) { ?><img src="<?php echo $item->p_image_url; ?>" alt="" class="thumbnail" style="max-width: 60px;"><?php
                        } else {
