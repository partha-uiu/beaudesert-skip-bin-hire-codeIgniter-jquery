        ...
        $('#dataTable .bulk-delete').each(function() {
            $(this).click(function(e) {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url: '<?php echo site_url(CPREFIX . "/products/deleteType") ?>',
                    dataType: 'json',
    ...
    <div class="span12">
        <div class="box">
            <header>
                ...
                <h5 style="display: inline-block; font-size: 18px; font-weight: bold;"> Waste Type List</h5>
            </header>
            <div id="collapse4" class="body">
                <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                    ...
                    <th> Waste  Title</th>
                    <th> Waste Type Accepted</th>
                    <th>Waste Type Not accepted</th>
...
<!--                                <td><?php // echo $item->product_id;?></td>-->
                                ...
                                <td><?php echo $item->p_type_accepted;?></td>
                                  <!--<td><?php // echo $item->id;?></td>-->
                                <td><?php echo $item->p_type_not_accepted;?></td>
                                ...
                                <td class="action">
                                <a href="  <?php echo site_url(CPREFIX . "/products/product_type/" . $item->id)?>"><i class="icon-pencil"></i> Edit</a>&nbsp;&nbsp;
