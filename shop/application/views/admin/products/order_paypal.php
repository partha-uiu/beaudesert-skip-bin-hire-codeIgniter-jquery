...
?>">
    <div class="span12">
        <div class="box">
            <header>
                <div class="icons"><i class="fa fa-paypal" style="font-size: 20px; color: #0066cc;"></i></div>
                <h5 style="display: inline-block; font-size: 18px; font-weight: bold;">Orders in Paypal</h5>
            </header>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($invoice as $cnt) { ?>
                         <?php if (!empty($cnt->invoice_no)){ ?>
                            ...
                            ?>
                    <tr>
                                <td class="center"><input class="check list-control-check" type="checkbox" value="<?php echo $cnt->id ?>" /></td>
                                ...
                                <td><select style ="width: 115px;" class="status" data-id="<?php echo $cnt->id ?>">
                                ...
                                <td class="action">
                                    <a href="  <?php echo site_url(CPREFIX . "/products/order_paypal_edit/" . $cnt->id) ?>"><i class="icon-pencil"></i> Edit</a>&nbsp;&nbsp;
                                    <a href="<?php echo site_url(CPREFIX . "/products/order_paypal_delete/" . $cnt->id) ?>"class="single-delete"><i class="icon-trash"></i> Delete</a>
                                </td>
                                <td></td>
                      </tr>    
                        <?php } ?>
