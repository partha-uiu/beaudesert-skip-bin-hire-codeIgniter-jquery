        ...
        $('#dataTable .bulk-delete').each(function() {
            $(this).click(function(e) {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url: '<?php echo site_url(CPREFIX . "/products/deleteSettings") ?>',
                    dataType: 'json',
    ...
    <div class="span12">
        <div class="box">
            <header>
                ...
                <h5 style="display: inline-block; font-size: 18px; font-weight: bold;">Extra Product Settings List</h5>
            </header>
                    ...
                    <tbody>
                        <?php foreach ($items as $item) { ?>
                            <tr>
                                ...
                                <td class="action">
                                <a href="  <?php echo site_url(CPREFIX . "/products/product_settings/" . $item->id)?>"><i class="icon-pencil"></i> Edit</a>&nbsp;&nbsp;
