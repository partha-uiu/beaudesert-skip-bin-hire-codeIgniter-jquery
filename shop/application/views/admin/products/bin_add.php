    ...
    <div class="span12">
        <div class="box for-form-horizontal">
            <header>
                ...
                <h5 style="display: inline-block; font-size: 18px; font-weight: bold;">Add Bin</h5>
                <div class="toolbar">
                    <ul class="nav">
                        <li>
                            <div class="btn-group">
...
//                    ));
           ...
           <?php echo $this->ahrform->input(array('name' => 'p_available_bin', 'type' => 'text', 'label' => 'Available Bin')); ?>
